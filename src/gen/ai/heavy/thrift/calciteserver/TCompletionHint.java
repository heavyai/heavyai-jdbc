...
public class TCompletionHint implements org.apache.thrift.TBase<TCompletionHint, TCompletionHint._Fields>, java.io.Serializable, Cloneable, Comparable<TCompletionHint> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable TCompletionHintType type; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> hints; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String replaced; // required
   ...
   * @see TCompletionHintType
   */
  public TCompletionHint setType(@org.apache.thrift.annotation.Nullable TCompletionHintType type) {
    this.type = type;
    return this;
  }
  ...
  public TCompletionHint setHints(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> hints) {
    this.hints = hints;
    return this;
  }
  ...
  public TCompletionHint setReplaced(@org.apache.thrift.annotation.Nullable java.lang.String replaced) {
    this.replaced = replaced;
    return this;
  }
  ...
  public int compareTo(TCompletionHint other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHints(), other.isSetHints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHints()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReplaced(), other.isSetReplaced());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReplaced()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = ai.heavy.thrift.calciteserver.TCompletionHintType.findByValue(iprot.readI32());
