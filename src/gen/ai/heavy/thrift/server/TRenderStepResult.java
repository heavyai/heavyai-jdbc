...
public class TRenderStepResult implements org.apache.thrift.TBase<TRenderStepResult, TRenderStepResult._Fields>, java.io.Serializable, Cloneable, Comparable<TRenderStepResult> {
  ...
  public int compareTo(TRenderStepResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMerge_data(), other.isSetMerge_data());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRaw_pixel_data(), other.isSetRaw_pixel_data());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRaw_pixel_data()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRender_time_ms(), other.isSetRender_time_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetTotal_time_ms(), other.isSetTotal_time_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.merge_data = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>>(2*_map250.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key251;
                @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>> _val252;
                for (int _i253 = 0; _i253 < _map250.size; ++_i253)
                {
                  _key251 = iprot.readString();
                  {
                    ...
                    _val252 = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>(2*_map254.size);
                    @org.apache.thrift.annotation.Nullable java.lang.String _key255;
                    @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>> _val256;
                    for (int _i257 = 0; _i257 < _map254.size; ++_i257)
                    {
                      _key255 = iprot.readString();
                      {
                        ...
                        _val256 = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>(2*_map258.size);
                        @org.apache.thrift.annotation.Nullable java.lang.String _key259;
                        @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.List<TRenderDatum>> _val260;
                        for (int _i261 = 0; _i261 < _map258.size; ++_i261)
                        {
                          _key259 = iprot.readString();
                          {
                            ...
                            _val260 = new java.util.HashMap<java.lang.String,java.util.List<TRenderDatum>>(2*_map262.size);
                            @org.apache.thrift.annotation.Nullable java.lang.String _key263;
                            @org.apache.thrift.annotation.Nullable java.util.List<TRenderDatum> _val264;
                            for (int _i265 = 0; _i265 < _map262.size; ++_i265)
                            {
                              _key263 = iprot.readString();
                              {
                                ...
                                _val264 = new java.util.ArrayList<TRenderDatum>(_list266.size);
                                @org.apache.thrift.annotation.Nullable TRenderDatum _elem267;
                                for (int _i268 = 0; _i268 < _list266.size; ++_i268)
                                {
                                  _elem267 = new TRenderDatum();
                                  _elem267.read(iprot);
                  ...
                  struct.merge_data.put(_key251, _val252);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRenderStepResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.merge_data != null) {
        oprot.writeFieldBegin(MERGE_DATA_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>> _iter269 : struct.merge_data.entrySet())
          {
            oprot.writeString(_iter269.getKey());
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, _iter269.getValue().size()));
              for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>> _iter270 : _iter269.getValue().entrySet())
              {
                oprot.writeString(_iter270.getKey());
                {
                  oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, _iter270.getValue().size()));
                  for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.List<TRenderDatum>>> _iter271 : _iter270.getValue().entrySet())
                  {
                    oprot.writeString(_iter271.getKey());
                    {
                      oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, _iter271.getValue().size()));
                      for (java.util.Map.Entry<java.lang.String, java.util.List<TRenderDatum>> _iter272 : _iter271.getValue().entrySet())
                      {
                        oprot.writeString(_iter272.getKey());
                        {
                          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter272.getValue().size()));
                          for (TRenderDatum _iter273 : _iter272.getValue())
                          {
  ...
  private static class TRenderStepResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRenderStepResult> {
      ...
      if (struct.isSetMerge_data()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>> _iter274 : struct.merge_data.entrySet())
          {
            oprot.writeString(_iter274.getKey());
            {
              oprot.writeI32(_iter274.getValue().size());
              for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>> _iter275 : _iter274.getValue().entrySet())
              {
                oprot.writeString(_iter275.getKey());
                {
                  oprot.writeI32(_iter275.getValue().size());
                  for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,java.util.List<TRenderDatum>>> _iter276 : _iter275.getValue().entrySet())
                  {
                    oprot.writeString(_iter276.getKey());
                    {
                      oprot.writeI32(_iter276.getValue().size());
                      for (java.util.Map.Entry<java.lang.String, java.util.List<TRenderDatum>> _iter277 : _iter276.getValue().entrySet())
                      {
                        oprot.writeString(_iter277.getKey());
                        {
                          oprot.writeI32(_iter277.getValue().size());
                          for (TRenderDatum _iter278 : _iter277.getValue())
                          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRenderStepResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map279 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP); 
          struct.merge_data = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>>(2*_map279.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key280;
          @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>> _val281;
          for (int _i282 = 0; _i282 < _map279.size; ++_i282)
          {
            _key280 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map283 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP); 
              _val281 = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>>(2*_map283.size);
              @org.apache.thrift.annotation.Nullable java.lang.String _key284;
              @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>> _val285;
              for (int _i286 = 0; _i286 < _map283.size; ++_i286)
              {
                _key284 = iprot.readString();
                {
                  org.apache.thrift.protocol.TMap _map287 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP); 
                  _val285 = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,java.util.List<TRenderDatum>>>(2*_map287.size);
                  @org.apache.thrift.annotation.Nullable java.lang.String _key288;
                  @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.util.List<TRenderDatum>> _val289;
                  for (int _i290 = 0; _i290 < _map287.size; ++_i290)
                  {
                    _key288 = iprot.readString();
                    {
                      org.apache.thrift.protocol.TMap _map291 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST); 
                      _val289 = new java.util.HashMap<java.lang.String,java.util.List<TRenderDatum>>(2*_map291.size);
                      @org.apache.thrift.annotation.Nullable java.lang.String _key292;
                      @org.apache.thrift.annotation.Nullable java.util.List<TRenderDatum> _val293;
                      for (int _i294 = 0; _i294 < _map291.size; ++_i294)
                      {
                        _key292 = iprot.readString();
                        {
                          ...
                          _val293 = new java.util.ArrayList<TRenderDatum>(_list295.size);
                          @org.apache.thrift.annotation.Nullable TRenderDatum _elem296;
                          for (int _i297 = 0; _i297 < _list295.size; ++_i297)
                          {
                            _elem296 = new TRenderDatum();
                            _elem296.read(iprot);
                            _val293.add(_elem296);
                          }
                        }
                        _val289.put(_key292, _val293);
                      }
                    }
                    _val285.put(_key288, _val289);
                  }
                }
                _val281.put(_key284, _val285);
              }
            }
            struct.merge_data.put(_key280, _val281);
          }
        }
        struct.setMerge_dataIsSet(true);
      }
