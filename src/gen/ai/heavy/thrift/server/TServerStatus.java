...
public class TServerStatus implements org.apache.thrift.TBase<TServerStatus, TServerStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TServerStatus> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String edition; // required
  ...
  public TServerStatus setVersion(@org.apache.thrift.annotation.Nullable java.lang.String version) {
    this.version = version;
    return this;
  }
  ...
  public TServerStatus setEdition(@org.apache.thrift.annotation.Nullable java.lang.String edition) {
    this.edition = edition;
    return this;
  }
  ...
  public TServerStatus setHost_name(@org.apache.thrift.annotation.Nullable java.lang.String host_name) {
    this.host_name = host_name;
    return this;
  }
   ...
   * @see TRole
   */
  public TServerStatus setRole(@org.apache.thrift.annotation.Nullable TRole role) {
    this.role = role;
    return this;
  }
  ...
  public int compareTo(TServerStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRead_only(), other.isSetRead_only());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRendering_enabled(), other.isSetRendering_enabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetEdition(), other.isSetEdition());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEdition()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHost_name(), other.isSetHost_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHost_name()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPoly_rendering_enabled(), other.isSetPoly_rendering_enabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRenderer_status_json(), other.isSetRenderer_status_json());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRenderer_status_json()) {
        ...
        switch (schemeField.id) {
          ...
          case 8: // ROLE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.role = ai.heavy.thrift.server.TRole.findByValue(iprot.readI32());
