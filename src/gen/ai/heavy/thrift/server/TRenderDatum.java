...
public class TRenderDatum implements org.apache.thrift.TBase<TRenderDatum, TRenderDatum._Fields>, java.io.Serializable, Cloneable, Comparable<TRenderDatum> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable ai.heavy.thrift.server.TDatumType type; // required
  ...
  public TRenderDatum(
    ai.heavy.thrift.server.TDatumType type,
    int cnt,
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public ai.heavy.thrift.server.TDatumType getType() {
    return this.type;
  }
   ...
   * @see ai.heavy.thrift.server.TDatumType
   */
  public TRenderDatum setType(@org.apache.thrift.annotation.Nullable ai.heavy.thrift.server.TDatumType type) {
    this.type = type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TYPE:
      if (value == null) {
        ...
        setType((ai.heavy.thrift.server.TDatumType)value);
      }
      break;
  ...
  public int compareTo(TRenderDatum other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCnt(), other.isSetCnt());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCnt()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = ai.heavy.thrift.server.TDatumType.findByValue(iprot.readI32());
