...
public class TInsertData implements org.apache.thrift.TBase<TInsertData, TInsertData._Fields>, java.io.Serializable, Cloneable, Comparable<TInsertData> {
  ...
  public TInsertData setColumn_ids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> column_ids) {
    this.column_ids = column_ids;
    return this;
  }
  ...
  public TInsertData setData(@org.apache.thrift.annotation.Nullable java.util.List<TDataBlockPtr> data) {
    this.data = data;
    return this;
  }
  ...
  public int compareTo(TInsertData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetColumn_ids(), other.isSetColumn_ids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetColumn_ids()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TDataBlockPtr _elem204;
  ...
  private static class TInsertDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<TInsertData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TInsertData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list215 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list221 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
