...
public class TDBObject implements org.apache.thrift.TBase<TDBObject, TDBObject._Fields>, java.io.Serializable, Cloneable, Comparable<TDBObject> {
   ...
   * @see TDBObjectType
   */
  public @org.apache.thrift.annotation.Nullable TDBObjectType objectType; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Boolean> privs; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String grantee; // required
  /**
   * 
   * @see TDBObjectType
   */
  ...
  public TDBObject setObjectName(@org.apache.thrift.annotation.Nullable java.lang.String objectName) {
    this.objectName = objectName;
    return this;
  }
   ...
   * @see TDBObjectType
   */
  public TDBObject setObjectType(@org.apache.thrift.annotation.Nullable TDBObjectType objectType) {
    this.objectType = objectType;
    return this;
  }
  ...
  public TDBObject setPrivs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Boolean> privs) {
    this.privs = privs;
    return this;
  }
  ...
  public TDBObject setGrantee(@org.apache.thrift.annotation.Nullable java.lang.String grantee) {
    this.grantee = grantee;
    return this;
  }
   ...
   * @see TDBObjectType
   */
  public TDBObject setPrivilegeObjectType(@org.apache.thrift.annotation.Nullable TDBObjectType privilegeObjectType) {
    this.privilegeObjectType = privilegeObjectType;
    return this;
  }
  ...
  public int compareTo(TDBObject other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPrivs(), other.isSetPrivs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrivs()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPrivilegeObjectType(), other.isSetPrivilegeObjectType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrivilegeObjectType()) {
        ...
        switch (schemeField.id) {
          ...
          case 2: // OBJECT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.objectType = ai.heavy.thrift.server.TDBObjectType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.privs = new java.util.ArrayList<java.lang.Boolean>(_list298.size);
                boolean _elem299;
                for (int _i300 = 0; _i300 < _list298.size; ++_i300)
                {
                  _elem299 = iprot.readBool();
                  struct.privs.add(_elem299);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // PRIVILEGE_OBJECT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.privilegeObjectType = ai.heavy.thrift.server.TDBObjectType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDBObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.privs != null) {
        oprot.writeFieldBegin(PRIVS_FIELD_DESC);
        {
          ...
          for (boolean _iter301 : struct.privs)
          {
  ...
  private static class TDBObjectTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDBObject> {
      ...
      if (struct.isSetPrivs()) {
        {
          ...
          for (boolean _iter302 : struct.privs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDBObject struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list303 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
          struct.privs = new java.util.ArrayList<java.lang.Boolean>(_list303.size);
          boolean _elem304;
          for (int _i305 = 0; _i305 < _list303.size; ++_i305)
          {
            _elem304 = iprot.readBool();
            struct.privs.add(_elem304);
          }
        }
        struct.setPrivsIsSet(true);
      }
