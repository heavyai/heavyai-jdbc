...
public class TTableDetails implements org.apache.thrift.TBase<TTableDetails, TTableDetails._Fields>, java.io.Serializable, Cloneable, Comparable<TTableDetails> {
  ...
  private static final org.apache.thrift.protocol.TField TABLE_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("table_type", org.apache.thrift.protocol.TType.I32, (short)10);
  private static final org.apache.thrift.protocol.TField REFRESH_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("refresh_info", org.apache.thrift.protocol.TType.STRUCT, (short)11);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String view_sql; // required
  public long shard_count; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String key_metainfo; // required
  public boolean is_temporary; // required
  /**
   * 
   * @see TPartitionDetail
   */
  public @org.apache.thrift.annotation.Nullable TPartitionDetail partition_detail; // required
  /**
   * 
   * @see TTableType
   */
  public @org.apache.thrift.annotation.Nullable TTableType table_type; // required
  public @org.apache.thrift.annotation.Nullable TTableRefreshInfo refresh_info; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * @see TTableType
     */
    TABLE_TYPE((short)10, "table_type"),
    REFRESH_INFO((short)11, "refresh_info");
  ...
  static {
    ...
    tmpMap.put(_Fields.TABLE_TYPE, new org.apache.thrift.meta_data.FieldMetaData("table_type", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, TTableType.class)));
    tmpMap.put(_Fields.REFRESH_INFO, new org.apache.thrift.meta_data.FieldMetaData("refresh_info", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TTableRefreshInfo.class)));
    ...
    TTableRefreshInfo refresh_info)
  {
    ...
    this.refresh_info = refresh_info;
  }
  ...
  public TTableDetails(TTableDetails other) {
    ...
    if (other.isSetRefresh_info()) {
      this.refresh_info = new TTableRefreshInfo(other.refresh_info);
    }
  }
  ...
  public TTableDetails setRow_desc(@org.apache.thrift.annotation.Nullable java.util.List<TColumnType> row_desc) {
    this.row_desc = row_desc;
    return this;
  }
  ...
  public TTableDetails setView_sql(@org.apache.thrift.annotation.Nullable java.lang.String view_sql) {
    this.view_sql = view_sql;
    return this;
  }
  ...
  public TTableDetails setKey_metainfo(@org.apache.thrift.annotation.Nullable java.lang.String key_metainfo) {
    this.key_metainfo = key_metainfo;
    return this;
  }
   ...
   * @see TPartitionDetail
   */
  public TTableDetails setPartition_detail(@org.apache.thrift.annotation.Nullable TPartitionDetail partition_detail) {
    this.partition_detail = partition_detail;
    return this;
  }
   ...
   * @see TTableType
   */
  public TTableDetails setTable_type(@org.apache.thrift.annotation.Nullable TTableType table_type) {
    this.table_type = table_type;
    return this;
  }
  ...
  public TTableDetails setRefresh_info(@org.apache.thrift.annotation.Nullable TTableRefreshInfo refresh_info) {
    this.refresh_info = refresh_info;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case REFRESH_INFO:
      if (value == null) {
        ...
        setRefresh_info((TTableRefreshInfo)value);
      }
      break;
  ...
  public boolean equals(TTableDetails that) {
    ...
    boolean this_present_refresh_info = true && this.isSetRefresh_info();
    boolean that_present_refresh_info = true && that.isSetRefresh_info();
    if (this_present_refresh_info || that_present_refresh_info) {
      if (!(this_present_refresh_info && that_present_refresh_info))
        return false;
      if (!this.refresh_info.equals(that.refresh_info))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRefresh_info()) ? 131071 : 524287);
    if (isSetRefresh_info())
      hashCode = hashCode * 8191 + refresh_info.hashCode();
  ...
  public int compareTo(TTableDetails other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRow_desc(), other.isSetRow_desc());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFragment_size(), other.isSetFragment_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetPage_size(), other.isSetPage_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPage_size()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMax_rows(), other.isSetMax_rows());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMax_rows()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetView_sql(), other.isSetView_sql());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetView_sql()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetShard_count(), other.isSetShard_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShard_count()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetKey_metainfo(), other.isSetKey_metainfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKey_metainfo()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_temporary(), other.isSetIs_temporary());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetPartition_detail(), other.isSetPartition_detail());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartition_detail()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRefresh_info(), other.isSetRefresh_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRefresh_info()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.refresh_info, other.refresh_info);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TTableDetailsStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTableDetails> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TColumnType _elem161;
          ...
          case 9: // PARTITION_DETAIL
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.partition_detail = ai.heavy.thrift.server.TPartitionDetail.findByValue(iprot.readI32());
          ...
          case 10: // TABLE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.table_type = ai.heavy.thrift.server.TTableType.findByValue(iprot.readI32());
          ...
          case 11: // REFRESH_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.refresh_info = new TTableRefreshInfo();
              struct.refresh_info.read(iprot);
              struct.setRefresh_infoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTableDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.refresh_info != null) {
        oprot.writeFieldBegin(REFRESH_INFO_FIELD_DESC);
        struct.refresh_info.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TColumnType _elem166;
