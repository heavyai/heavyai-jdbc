...
public class TPixelTableRowResult implements org.apache.thrift.TBase<TPixelTableRowResult, TPixelTableRowResult._Fields>, java.io.Serializable, Cloneable, Comparable<TPixelTableRowResult> {
  ...
  public int compareTo(TPixelTableRowResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPixel(), other.isSetPixel());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetVega_table_name(), other.isSetVega_table_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVega_table_name()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRow_id(), other.isSetRow_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRow_id()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRow_set(), other.isSetRow_set());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRow_set()) {
  ...
  private static class TPixelTableRowResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPixelTableRowResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPixelTableRowResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list106 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
