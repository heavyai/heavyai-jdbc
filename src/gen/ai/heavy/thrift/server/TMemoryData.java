...
public class TMemoryData implements org.apache.thrift.TBase<TMemoryData, TMemoryData._Fields>, java.io.Serializable, Cloneable, Comparable<TMemoryData> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> chunk_key; // required
  ...
  public TMemoryData setChunk_key(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> chunk_key) {
    this.chunk_key = chunk_key;
    return this;
  }
  ...
  public int compareTo(TMemoryData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSlab(), other.isSetSlab());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStart_page(), other.isSetStart_page());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStart_page()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_pages(), other.isSetNum_pages());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNum_pages()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTouch(), other.isSetTouch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTouch()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChunk_key(), other.isSetChunk_key());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChunk_key()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuffer_epoch(), other.isSetBuffer_epoch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_free(), other.isSetIs_free());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_free()) {
