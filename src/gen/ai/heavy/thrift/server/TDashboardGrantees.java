...
public class TDashboardGrantees implements org.apache.thrift.TBase<TDashboardGrantees, TDashboardGrantees._Fields>, java.io.Serializable, Cloneable, Comparable<TDashboardGrantees> {
  ...
  public TDashboardGrantees setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TDashboardGrantees setPermissions(@org.apache.thrift.annotation.Nullable TDashboardPermissions permissions) {
    this.permissions = permissions;
    return this;
  }
  ...
  public int compareTo(TDashboardGrantees other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_user(), other.isSetIs_user());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_user()) {
