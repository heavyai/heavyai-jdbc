...
public class TTypeInfo implements org.apache.thrift.TBase<TTypeInfo, TTypeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeInfo> {
  ...
  public int compareTo(TTypeInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_array(), other.isSetIs_array());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_array()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetComp_param(), other.isSetComp_param());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComp_param()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TTypeInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // ENCODING
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.encoding = ai.heavy.thrift.server.TEncodingType.findByValue(iprot.readI32());
