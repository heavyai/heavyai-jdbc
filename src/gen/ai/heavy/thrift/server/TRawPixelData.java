...
public class TRawPixelData implements org.apache.thrift.TBase<TRawPixelData, TRawPixelData._Fields>, java.io.Serializable, Cloneable, Comparable<TRawPixelData> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.render_pass_map = new java.util.HashMap<java.lang.Integer,TRawRenderPassDataResult>(2*_map240.size);
                int _key241;
                @org.apache.thrift.annotation.Nullable TRawRenderPassDataResult _val242;
                for (int _i243 = 0; _i243 < _map240.size; ++_i243)
                {
                  _key241 = iprot.readI32();
                  _val242 = new TRawRenderPassDataResult();
                  _val242.read(iprot);
                  struct.render_pass_map.put(_key241, _val242);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRawPixelData struct) throws org.apache.thrift.TException {
      ...
      if (struct.render_pass_map != null) {
        oprot.writeFieldBegin(RENDER_PASS_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, TRawRenderPassDataResult> _iter244 : struct.render_pass_map.entrySet())
          {
  ...
  private static class TRawPixelDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRawPixelData> {
      ...
      if (struct.isSetRender_pass_map()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, TRawRenderPassDataResult> _iter245 : struct.render_pass_map.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRawPixelData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map246 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.render_pass_map = new java.util.HashMap<java.lang.Integer,TRawRenderPassDataResult>(2*_map246.size);
          int _key247;
          @org.apache.thrift.annotation.Nullable TRawRenderPassDataResult _val248;
          for (int _i249 = 0; _i249 < _map246.size; ++_i249)
          {
            _key247 = iprot.readI32();
            _val248 = new TRawRenderPassDataResult();
            _val248.read(iprot);
            struct.render_pass_map.put(_key247, _val248);
          }
        }
        struct.setRender_pass_mapIsSet(true);
      }
