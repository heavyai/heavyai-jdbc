...
public class TColSlotContext implements org.apache.thrift.TBase<TColSlotContext, TColSlotContext._Fields>, java.io.Serializable, Cloneable, Comparable<TColSlotContext> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TSlotSize> slot_sizes; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Integer>> col_to_slot_map; // required
  ...
  public TColSlotContext setSlot_sizes(@org.apache.thrift.annotation.Nullable java.util.List<TSlotSize> slot_sizes) {
    this.slot_sizes = slot_sizes;
    return this;
  }
  ...
  public TColSlotContext setCol_to_slot_map(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Integer>> col_to_slot_map) {
    this.col_to_slot_map = col_to_slot_map;
    return this;
  }
  ...
  public int compareTo(TColSlotContext other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSlot_sizes(), other.isSetSlot_sizes());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCol_to_slot_map(), other.isSetCol_to_slot_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCol_to_slot_map()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TSlotSize _elem1;
      ...
      if (incoming.get(0)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TSlotSize _elem16;
      ...
      if (incoming.get(1)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> _elem19;
