...
public class TSerializedRows implements org.apache.thrift.TBase<TSerializedRows, TSerializedRows._Fields>, java.io.Serializable, Cloneable, Comparable<TSerializedRows> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> buffers; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> buffer_lengths; // required
  public long buffers_total_size; // required
  public int total_compression_time_ms; // required
  public @org.apache.thrift.annotation.Nullable TResultSetBufferDescriptor descriptor; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<TTargetInfo> targets; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> target_init_vals; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> varlen_buffer; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<TCountDistinctSet> count_distinct_sets; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String explanation; // required
  ...
  public TSerializedRows setBuffers(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> buffers) {
    this.buffers = buffers;
    return this;
  }
  ...
  public TSerializedRows setBuffer_lengths(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> buffer_lengths) {
    this.buffer_lengths = buffer_lengths;
    return this;
  }
  ...
  public TSerializedRows setDescriptor(@org.apache.thrift.annotation.Nullable TResultSetBufferDescriptor descriptor) {
    this.descriptor = descriptor;
    return this;
  }
  ...
  public TSerializedRows setTargets(@org.apache.thrift.annotation.Nullable java.util.List<TTargetInfo> targets) {
    this.targets = targets;
    return this;
  }
  ...
  public TSerializedRows setTarget_init_vals(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> target_init_vals) {
    this.target_init_vals = target_init_vals;
    return this;
  }
  ...
  public TSerializedRows setVarlen_buffer(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> varlen_buffer) {
    this.varlen_buffer = varlen_buffer;
    return this;
  }
  ...
  public TSerializedRows setCount_distinct_sets(@org.apache.thrift.annotation.Nullable java.util.List<TCountDistinctSet> count_distinct_sets) {
    this.count_distinct_sets = count_distinct_sets;
    return this;
  }
  ...
  public TSerializedRows setExplanation(@org.apache.thrift.annotation.Nullable java.lang.String explanation) {
    this.explanation = explanation;
    return this;
  }
  ...
  public int compareTo(TSerializedRows other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuffers(), other.isSetBuffers());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuffer_lengths(), other.isSetBuffer_lengths());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuffer_lengths()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBuffers_total_size(), other.isSetBuffers_total_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetTotal_compression_time_ms(), other.isSetTotal_compression_time_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetDescriptor(), other.isSetDescriptor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDescriptor()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTarget_init_vals(), other.isSetTarget_init_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTarget_init_vals()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetVarlen_buffer(), other.isSetVarlen_buffer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVarlen_buffer()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCount_distinct_sets(), other.isSetCount_distinct_sets());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCount_distinct_sets()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TTargetInfo _elem63;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TCountDistinctSet _elem72;
  ...
  private static class TSerializedRowsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSerializedRows> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSerializedRows struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list89 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
      ...
      if (incoming.get(5)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TTargetInfo _elem93;
      ...
      if (incoming.get(8)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TCountDistinctSet _elem102;
