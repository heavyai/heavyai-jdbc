...
public class TCopyParams implements org.apache.thrift.TBase<TCopyParams, TCopyParams._Fields>, java.io.Serializable, Cloneable, Comparable<TCopyParams> {
   ...
   */
  public com.omnisci.thrift.server.TEncodingType geo_coords_encoding; // required
  public int geo_coords_comp_param; // required
  /**
   * 
   * @see com.omnisci.thrift.server.TDatumType
   */
  public com.omnisci.thrift.server.TDatumType geo_coords_type; // required
   ...
   * @see com.omnisci.thrift.server.TEncodingType
   */
  public TCopyParams setGeo_coords_encoding(com.omnisci.thrift.server.TEncodingType geo_coords_encoding) {
    this.geo_coords_encoding = geo_coords_encoding;
    return this;
  }
   ...
   * @see com.omnisci.thrift.server.TDatumType
   */
  public TCopyParams setGeo_coords_type(com.omnisci.thrift.server.TDatumType geo_coords_type) {
    this.geo_coords_type = geo_coords_type;
    return this;
  }
