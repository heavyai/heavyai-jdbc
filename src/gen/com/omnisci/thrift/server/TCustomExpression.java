...
public class TCustomExpression implements org.apache.thrift.TBase<TCustomExpression, TCustomExpression._Fields>, java.io.Serializable, Cloneable, Comparable<TCustomExpression> {
  ...
  public int compareTo(TCustomExpression other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExpression_json()).compareTo(other.isSetExpression_json());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExpression_json()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetData_source_type()).compareTo(other.isSetData_source_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetData_source_type()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetData_source_id()).compareTo(other.isSetData_source_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIs_deleted()).compareTo(other.isSetIs_deleted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_deleted()) {
