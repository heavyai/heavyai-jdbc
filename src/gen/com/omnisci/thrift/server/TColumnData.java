...
public class TColumnData implements org.apache.thrift.TBase<TColumnData, TColumnData._Fields>, java.io.Serializable, Cloneable, Comparable<TColumnData> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> int_col; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> real_col; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> str_col; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<TColumn> arr_col; // required
  ...
  public TColumnData setInt_col(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> int_col) {
    this.int_col = int_col;
    return this;
  }
  ...
  public TColumnData setReal_col(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> real_col) {
    this.real_col = real_col;
    return this;
  }
  ...
  public TColumnData setStr_col(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> str_col) {
    this.str_col = str_col;
    return this;
  }
  ...
  public TColumnData setArr_col(@org.apache.thrift.annotation.Nullable java.util.List<TColumn> arr_col) {
    this.arr_col = arr_col;
    return this;
  }
  ...
  public int compareTo(TColumnData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInt_col(), other.isSetInt_col());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReal_col(), other.isSetReal_col());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReal_col()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStr_col(), other.isSetStr_col());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStr_col()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetArr_col(), other.isSetArr_col());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArr_col()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TColumn _elem26;
  ...
  private static class TColumnDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<TColumnData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TColumnData struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list36 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list39 = iprot.readListBegin(org.apache.thrift.protocol.TType.DOUBLE);
      ...
      if (incoming.get(3)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TColumn _elem46;
