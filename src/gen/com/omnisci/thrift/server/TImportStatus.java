...
public class TImportStatus implements org.apache.thrift.TBase<TImportStatus, TImportStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TImportStatus> {
  ...
  public int compareTo(TImportStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRows_completed(), other.isSetRows_completed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRows_estimated(), other.isSetRows_estimated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRows_rejected(), other.isSetRows_rejected());
    if (lastComparison != 0) {
      return lastComparison;
    }
