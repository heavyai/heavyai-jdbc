...
public class TNodeMemoryInfo implements org.apache.thrift.TBase<TNodeMemoryInfo, TNodeMemoryInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TNodeMemoryInfo> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TMemoryData> node_memory_data; // required
  ...
  public TNodeMemoryInfo setHost_name(@org.apache.thrift.annotation.Nullable java.lang.String host_name) {
    this.host_name = host_name;
    return this;
  }
  ...
  public TNodeMemoryInfo setNode_memory_data(@org.apache.thrift.annotation.Nullable java.util.List<TMemoryData> node_memory_data) {
    this.node_memory_data = node_memory_data;
    return this;
  }
  ...
  public int compareTo(TNodeMemoryInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMax_num_pages(), other.isSetMax_num_pages());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_pages_allocated(), other.isSetNum_pages_allocated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetIs_allocation_capped(), other.isSetIs_allocation_capped());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetNode_memory_data(), other.isSetNode_memory_data());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNode_memory_data()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TMemoryData _elem137;
      ...
      if (incoming.get(5)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TMemoryData _elem142;
