...
public class TStringValue implements org.apache.thrift.TBase<TStringValue, TStringValue._Fields>, java.io.Serializable, Cloneable, Comparable<TStringValue> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String str_val; // required
  ...
  public TStringValue setStr_val(@org.apache.thrift.annotation.Nullable java.lang.String str_val) {
    this.str_val = str_val;
    return this;
  }
  ...
  public int compareTo(TStringValue other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStr_val(), other.isSetStr_val());
    if (lastComparison != 0) {
