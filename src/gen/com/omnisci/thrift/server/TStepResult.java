...
public class TStepResult implements org.apache.thrift.TBase<TStepResult, TStepResult._Fields>, java.io.Serializable, Cloneable, Comparable<TStepResult> {
  ...
  public int compareTo(TStepResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSerialized_rows(), other.isSetSerialized_rows());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetExecution_finished(), other.isSetExecution_finished());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetSharded(), other.isSetSharded());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSharded()) {
