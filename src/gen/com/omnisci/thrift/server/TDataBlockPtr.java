...
public class TDataBlockPtr extends org.apache.thrift.TUnion<TDataBlockPtr, TDataBlockPtr._Fields> {
        ...
        case VAR_LEN_DATA:
          if (field.type == VAR_LEN_DATA_FIELD_DESC.type) {
            java.util.List<TVarLen> var_len_data;
            {
              ...
              @org.apache.thrift.annotation.Nullable TVarLen _elem193;
      ...
      switch (setField) {
        ...
        case VAR_LEN_DATA:
          java.util.List<TVarLen> var_len_data;
          {
            ...
            @org.apache.thrift.annotation.Nullable TVarLen _elem197;
  ...
  public void setFixed_len_data(java.nio.ByteBuffer value) {
    ...
    value_ = java.util.Objects.requireNonNull(value,"_Fields.FIXED_LEN_DATA");
  }
  ...
  public void setVar_len_data(java.util.List<TVarLen> value) {
    ...
    value_ = java.util.Objects.requireNonNull(value,"_Fields.VAR_LEN_DATA");
  }
