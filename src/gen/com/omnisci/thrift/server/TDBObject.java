...
public class TDBObject implements org.apache.thrift.TBase<TDBObject, TDBObject._Fields>, java.io.Serializable, Cloneable, Comparable<TDBObject> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.privs = new java.util.ArrayList<java.lang.Boolean>(_list282.size);
                boolean _elem283;
                for (int _i284 = 0; _i284 < _list282.size; ++_i284)
                {
                  _elem283 = iprot.readBool();
                  struct.privs.add(_elem283);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDBObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.privs != null) {
        oprot.writeFieldBegin(PRIVS_FIELD_DESC);
        {
          ...
          for (boolean _iter285 : struct.privs)
          {
            oprot.writeBool(_iter285);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDBObjectTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDBObject> {
      ...
      if (struct.isSetPrivs()) {
        {
          ...
          for (boolean _iter286 : struct.privs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDBObject struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list287 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
          struct.privs = new java.util.ArrayList<java.lang.Boolean>(_list287.size);
          boolean _elem288;
          for (int _i289 = 0; _i289 < _list287.size; ++_i289)
          {
            _elem288 = iprot.readBool();
            struct.privs.add(_elem288);
          }
        }
        struct.setPrivsIsSet(true);
      }
