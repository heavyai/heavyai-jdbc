...
public class TGpuSpecification implements org.apache.thrift.TBase<TGpuSpecification, TGpuSpecification._Fields>, java.io.Serializable, Cloneable, Comparable<TGpuSpecification> {
  ...
  public int compareTo(TGpuSpecification other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_sm(), other.isSetNum_sm());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetClock_frequency_kHz(), other.isSetClock_frequency_kHz());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetMemory(), other.isSetMemory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMemory()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCompute_capability_major(), other.isSetCompute_capability_major());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetCompute_capability_minor(), other.isSetCompute_capability_minor());
    if (lastComparison != 0) {
      return lastComparison;
    }
