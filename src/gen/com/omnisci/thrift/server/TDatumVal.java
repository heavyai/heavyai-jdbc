...
public class TDatumVal implements org.apache.thrift.TBase<TDatumVal, TDatumVal._Fields>, java.io.Serializable, Cloneable, Comparable<TDatumVal> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TDatum> arr_val; // required
  ...
  public TDatumVal setStr_val(@org.apache.thrift.annotation.Nullable java.lang.String str_val) {
    this.str_val = str_val;
    return this;
  }
  ...
  public TDatumVal setArr_val(@org.apache.thrift.annotation.Nullable java.util.List<TDatum> arr_val) {
    this.arr_val = arr_val;
    return this;
  }
  ...
  public int compareTo(TDatumVal other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInt_val(), other.isSetInt_val());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReal_val(), other.isSetReal_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReal_val()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetArr_val(), other.isSetArr_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArr_val()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable TDatum _elem1;
      ...
      if (incoming.get(3)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable TDatum _elem6;
