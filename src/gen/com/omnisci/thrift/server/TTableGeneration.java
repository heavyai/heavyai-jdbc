...
public class TTableGeneration implements org.apache.thrift.TBase<TTableGeneration, TTableGeneration._Fields>, java.io.Serializable, Cloneable, Comparable<TTableGeneration> {
  ...
  public int compareTo(TTableGeneration other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTuple_count(), other.isSetTuple_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTuple_count()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStart_rowid(), other.isSetStart_rowid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStart_rowid()) {
