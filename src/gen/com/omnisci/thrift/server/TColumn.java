...
public class TColumn implements org.apache.thrift.TBase<TColumn, TColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TColumn> {
  ...
  public TColumnData data; // required
  public java.util.List<java.lang.Boolean> nulls; // required
  ...
  public TColumn setData(TColumnData data) {
    this.data = data;
    return this;
  }
  ...
  public TColumn setNulls(java.util.List<java.lang.Boolean> nulls) {
    this.nulls = nulls;
    return this;
  }
