...
public class TCountDistinctDescriptor implements org.apache.thrift.TBase<TCountDistinctDescriptor, TCountDistinctDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TCountDistinctDescriptor> {
  ...
  public int compareTo(TCountDistinctDescriptor other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetImpl_type(), other.isSetImpl_type());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBitmap_sz_bits(), other.isSetBitmap_sz_bits());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetApproximate(), other.isSetApproximate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApproximate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDevice_type(), other.isSetDevice_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDevice_type()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSub_bitmap_count(), other.isSetSub_bitmap_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
