...
public class THardwareInfo implements org.apache.thrift.TBase<THardwareInfo, THardwareInfo._Fields>, java.io.Serializable, Cloneable, Comparable<THardwareInfo> {
  ...
  public int compareTo(THardwareInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_gpu_hw(), other.isSetNum_gpu_hw());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_cpu_hw(), other.isSetNum_cpu_hw());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNum_cpu_hw()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNum_gpu_allocated(), other.isSetNum_gpu_allocated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetStart_gpu(), other.isSetStart_gpu());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStart_gpu()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetGpu_info(), other.isSetGpu_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGpu_info()) {
