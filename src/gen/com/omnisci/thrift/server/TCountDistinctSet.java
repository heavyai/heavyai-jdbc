...
public class TCountDistinctSet implements org.apache.thrift.TBase<TCountDistinctSet, TCountDistinctSet._Fields>, java.io.Serializable, Cloneable, Comparable<TCountDistinctSet> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable TCountDistinctImplType type; // required
  public @org.apache.thrift.annotation.Nullable TCountDistinctSetStorage storage; // required
   ...
   * @see TCountDistinctImplType
   */
  public TCountDistinctSet setType(@org.apache.thrift.annotation.Nullable TCountDistinctImplType type) {
    this.type = type;
    return this;
  }
  ...
  public TCountDistinctSet setStorage(@org.apache.thrift.annotation.Nullable TCountDistinctSetStorage storage) {
    this.storage = storage;
    return this;
  }
  ...
  public int compareTo(TCountDistinctSet other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRemote_ptr(), other.isSetRemote_ptr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRemote_ptr()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.omnisci.thrift.server.TCountDistinctImplType.findByValue(iprot.readI32());
