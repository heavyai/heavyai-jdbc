...
public class TUserDefinedFunction implements org.apache.thrift.TBase<TUserDefinedFunction, TUserDefinedFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TUserDefinedFunction> {
  ...
  public java.util.List<TExtArgumentType> argTypes; // required
  /**
   * 
   * @see TExtArgumentType
   */
  public TExtArgumentType retType; // required
  ...
  public TUserDefinedFunction setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TUserDefinedFunction setArgTypes(java.util.List<TExtArgumentType> argTypes) {
    this.argTypes = argTypes;
    return this;
  }
