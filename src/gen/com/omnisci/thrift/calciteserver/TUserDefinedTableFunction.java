        ...
        switch (schemeField.id) {
          ...
          case 2: // SIZER_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.sizerType = com.omnisci.thrift.calciteserver.TOutputBufferSizeType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem9 = com.omnisci.thrift.calciteserver.TExtArgumentType.findByValue(iprot.readI32());
                  if (_elem9 != null)
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem12 = com.omnisci.thrift.calciteserver.TExtArgumentType.findByValue(iprot.readI32());
                  if (_elem12 != null)
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem15 = com.omnisci.thrift.calciteserver.TExtArgumentType.findByValue(iprot.readI32());
                  if (_elem15 != null)
                  {
